...
//
// 举例 -- corpFlightBookings([][]int{{1, 2, 10}, {2, 3, 20}, {2, 5, 25}}, 5)
// 计算各站人数变化（车站编码从1开始，车站从1到n进行编号，为方便计算补充第一站的前一站和最后一站的后一站（即第0站和第n+1站））：
// +-----------------------------------------+
// |  0  |  1  |  2  |  3  |  4  |  5  |  6  |
// | --- |     |     |     |     |     | --- |
// |     | +10 |     | -10 |     |     |     |
...
func corpFlightBookings(bookings [][]int, n int) []int {
	...
	// 遍历计算每一站的人数变化记录 -- 车站编码从1开始，车站从1到n进行编号
	...
	// 返回第一站到最后一站的总人数 -- 此时diff[i]表示第i站时车上的总人数
	return diff[1 : n+1]
}
