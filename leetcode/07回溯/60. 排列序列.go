...
// getPermutation .
// 1. 回溯法在求全排列的过程中将k传入，找到一个排列就将k递减，直到找到第k个排列数后返回 -- 同 leetcode 46. 全排列 -- 此方法需要循环k次进行寻找
...
//    首先应该明白，以 1 开头的全排列有 5! 个，以 2 开头的全排列有 5! 个 ...，一共 5! * 6 = 6! 个，
//    - 故当 k = 373 时，全排列的第一个数字应该是 nums[k / 5!] = 4 ，
